 ...
 * @author Mostafa Badr
 */
public class EditservicemanagerController implements Initializable {
    ...
    String Total;
    String serviceNum;
    static EditservicemanagerController INSTANCE;
    ...
    private void printing(ActionEvent event) {
        ...
        if (a == b && day.equals(servicedate)) {
            ...
            try {
                ...
                INSTANCE = new EditservicemanagerController();
    ...
    public static boolean printcard(PrintService service, String R, String N, String D, String S, String T) throws Exception {
        ...
        Printable contePrintable = new Printable() {
            ...
            public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
                ...
                UsersSingleton Manager = UsersSingleton.getInstance();
                ...
                try {
                    ...
                    g2d.drawString("-------------------------------------", 12, y);
                    y += yShift;
                    g2d.drawString("  المستخدم:          " + Manager.getUserName() + "   ", 12, y);
                    y += headerRectHeight;
